...
plot3 <- ggplot(data=all_reads, aes(NoOfReadsinPuzzleCovALT)) + geom_histogram(binwidth=1) + scale_y_sqrt() + ggtitle("Selected & usable reads in Puzzle, covering ALT allele distribution")
